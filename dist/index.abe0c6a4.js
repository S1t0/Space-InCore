...
class Tanque extends _actor.Actor {
    ...
    draw(ctx1, delta1) {
        ...
        ctx1.drawImage(this.image, this.position.x, this.position.y, alto, ancho);
    }
    keyboard_event(key) {
...
class FPSviewer extends _actor.Actor {
    ...
    draw(ctx1, delta1) {
        const fps = (1 / delta1).toFixed(0);
        ctx1.font = '18px Arial';
        ctx1.fillStyle = "white";
        ctx1.fillText(`FPS:${fps}`, this.position.x, this.position.y);
    }
}

},{"../src/Actor":"5ReBW","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"23Ft1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
